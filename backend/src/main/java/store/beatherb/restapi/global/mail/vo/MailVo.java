...
public class MailVo {
    ...
    @Builder
    public MailVo(String address,String uuid) {
        ...
        this.message = "<html>\n" +
                ...
                "        <div>\n" +
                "          <a href=\"https://beatherb.store/auth_success?token=" + this.uuid +"\"> https://beatherb.store/auth_success?token=" + this.uuid +"</a>\n" +
                "        </div>\n" +
                "        <div></div>\n" +
                "        <div style=\"display: flex; justify-content: center\">\n" +
                "          <a href=\"https://beatherb.store/auth_success?token="+ this.uuid + "\">\n" +
                "            <button\n" +
                "              type=\"button\"\n" +
                "              style=\"\n" +
                "                color: #f5f5f5;\n" +
