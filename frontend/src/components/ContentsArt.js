...
export default function ContentsArt({ size, contentsId, albumArt, isFavorite, onClickFavorite, showFavorite }) {
  return (
    <div style={{width: `${size}px`}} className="relative">
      ...
      {
        showFavorite && 
        <label className="swap absolute bottom-2 right-2">
          <input type="checkbox" value={isFavorite} onClick={onClickFavorite} />
          <svg className="fill-red-600 swap-off" xmlns="http://www.w3.org/2000/svg" height="32" viewBox="0 -960 960 960" width="32">
          ...
          <svg className="fill-red-600 swap-on" xmlns="http://www.w3.org/2000/svg" height="32" viewBox="0 -960 960 960" width="32">
